...
class InstanceManager:
    ...
    def public_hosts(self, flat=False):
        if flat:
            return [x.public for x in self.hosts(flat)]
        else:
            return defaultdict(list, {k: [v.public for v in l] for k, l in self.hosts(flat).items()})
